...
class m201008_085216_create_widgets_discussioni_CMS extends Migration
{
    ...
    private function initWidgetsConfs()
    {
        $this->widgets = [
            [
                'classname' => \open20\amos\discussioni\widgets\graphics\WidgetGraphicsCmsUltimeDiscussioni::className(),

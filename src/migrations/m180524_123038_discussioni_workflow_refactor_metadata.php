...
/**
 * Class m180524_123038_discussioni_workflow_refactor_metadata
 */
class m180524_123038_discussioni_workflow_refactor_metadata extends AmosMigrationWorkflow
{
    ...
    const WORKFLOW_VALIDATED = 'ATTIVA';
